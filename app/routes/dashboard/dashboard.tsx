...
export default function Dashboard() {
  // Mock user data - would be fetched from API in real implementation
  const user = {
    name: "Jane Doe",
    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl bg-gradient-to-br from-indigo-50 via-white to-green-50 min-h-screen">
        ...
        <div className="flex flex-col md:flex-row md:items-center">
          <div className="flex items-center mb-4 md:mb-0">
            <img
              ...
              onError={(e) => {
                e.currentTarget.src = "https://via.placeholder.com/80?text=User";
              }}
            />
            <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100 hover:shadow-lg transition">
          ...
          <p className="text-3xl font-bold text-indigo-600">{user.itemsShared}</p>
        </div>
        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100 hover:shadow-lg transition">
          <h2 className="text-xl font-semibold mb-2">Items Redeemed</h2>
          <p className="text-3xl font-bold text-green-600">{user.itemsRedeemed}</p>
        </div>
        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100 hover:shadow-lg transition">
          <h2 className="text-xl font-semibold mb-2">Total Points Earned</h2>
          <p className="text-3xl font-bold text-yellow-500">{user.points + 180}</p>
        </div>
      </div>
