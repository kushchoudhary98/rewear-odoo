...
export default function Home() {
  ...
  return (
    <div className="bg-gradient-to-br from-indigo-50 via-white to-green-50">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-indigo-900 via-indigo-700 to-green-700 text-white py-20 overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-br from-indigo-900/80 via-indigo-700/60 to-green-700/60"></div>
        </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="flex overflow-x-auto space-x-4 pb-4 mb-6">
            {categories.map((category, index) => (
              <button
                key={index}
                className={`flex items-center px-4 py-2 whitespace-nowrap rounded-full border shadow-sm transition ${
                  index === 0
